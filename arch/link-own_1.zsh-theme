...
prompt_start() {
  #echo -n ""
  #prompt_segment $CURRENT_BG $YELLOW "\ue0b6$bg[yellow]$fg[black] $bg[blue]$fg[yellow]$SEGMENT_SEPARATOR"
  prompt_segment $CURRENT_BG $my_yellow "\ue0b6$bg[214]$fg[black] $bg[blue]$fg[yellow]$SEGMENT_SEPARATOR"
}
...
prompt_context() {
  if [[ "$USERNAME" != "$DEFAULT_USER" || -n "$SSH_CLIENT" ]]; then
    prompt_segment yellow black "%F{black}%n"
...
prompt_status() {
  ...
  [[ $RETVAL -ne 0 ]] && symbols+="$bg[red]$fg[black]✘"
